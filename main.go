...
func main() {
	...
	for !rl.WindowShouldClose() {
		...
		// // Display the Intro messsage
		// for intro < 300 && !rl.WindowShouldClose() {
		// 	rl.BeginDrawing()
		// 	rl.ClearBackground(rl.White)
		// 	rl.DrawText("Pong by Bertrand \"Berry\" Karake", 0.08*WinWidth, WinHeight/7, 60, rl.Black)
		// 	rl.DrawText("First to 5 points wins!", 0.1*WinWidth, WinHeight/2, 90, rl.Black)
		// 	rl.DrawText("Use W and S for Player One, Up Arrow and Down Arrow for Player Two", 0.01*WinWidth, 8*WinHeight/20, 30, rl.Black)
		// 	rl.DrawText(fmt.Sprint(intro/3)+"%", 0.5*WinWidth, 6*WinHeight/8, 90, rl.Black)
		// 	intro++
		// 	rl.EndDrawing()
		// }
		...
		// // If we have a winner, display the message for some time then close the program
		// for scoreOne == 5 || scoreTwo == 5 {
		// 	rl.BeginDrawing()
		// 	rl.ClearBackground(rl.White)
		// 	if scoreOne == 5 {
		// 		rl.DrawText("Dear Player Two, Why are you such a loser?", 0.08*WinWidth, WinHeight/2, 80, rl.Black)
		// 	} else {
		// 		rl.DrawText("Player One, you pathetic!", 0.08*WinWidth, WinHeight/2, 80, rl.Black)
		// 	}
		// 	intro--
		// 	if intro < 300 {
		// 		break
